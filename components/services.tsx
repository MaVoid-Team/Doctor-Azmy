  ...
  const services = [
    {
      ...
      desc: "تقنيات متقدمة لتفتيت الدهون وشد الترهلات بدون جراحة، مع جلسات ميزوثيرابي مركزة لنحت أسرع ونتائج أوضح.",
      icon: "✨",
      items: ["ليزر تفتيت الدهون", "تقنية Cavitation", "RF وEMT", "جلسات Mesotherapy"],
      gradient: "from-blue-500/10 to-cyan-500/10",
      border: "hover:border-blue-500/30"
    },
    {
      title: "تجميل البشرة والعناية",
      desc: "برامج متخصصة لتحسين نضارة البشرة باستخدام افضل انواع الميزوثيرابي لنضارة البشرة و تفتيحها و القضاء علي التجاعيد ",
      icon: "💆",
